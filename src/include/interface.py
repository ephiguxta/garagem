...
class Aplicacao:
    ...
    def telaOpcoes(self):
        ...
        img = customtkinter.CTkImage(
            dark_image=Image.open(caminhoDaImagem),
        ...
        rgClienteSave = customtkinter.StringVar(janela)
        ...
        def telaCadastrarFuncionario():
            ...
            frameLabelFuncionario = customtkinter.CTkFrame(
                janela, width=350, height=600
            )
            frameLabelFuncionario.pack(side=LEFT)

            label = customtkinter.CTkLabel(
                master=frameFuncionario,
                text="Cadastrar Funcionario",
            ).place(x=25, y=5)

            # Títulos
            labelCpfFuncionario = customtkinter.CTkLabel(
                frameLabelFuncionario,
                text="CPF: ",
            ).place(x=280, y=40)

            labelRgFuncionario = customtkinter.CTkLabel(
                frameLabelFuncionario,
                text="RG: ",
            ).place(x=280, y=80)

            labelNomeFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Nome: ",
            ).place(x=280, y=120)

            labelCargoFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Cargo: ",
            ).place(x=280, y=160)

            labelSalarioFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Salário: ",
            ).place(x=280, y=200)

            labelEnderecoFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Endereço: ",
            ).place(x=280, y=240)

            labelBairroFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Bairro: ",
            ).place(x=280, y=280)

            labelNumeroFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Número: ",
            ).place(x=280, y=320)

            labelCepFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Cep: ",
            ).place(x=280, y=360)

            labelEmailFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Email: ",
            ).place(x=280, y=400)

            labelTelefoneFuncionario = customtkinter.CTkLabel(
                master=frameLabelFuncionario,
                text="Telefone: ",
            ).place(x=280, y=440)
            # Entrada de dados
            cpfEntry = customtkinter.CTkEntry(
                frameFuncionario,
                width=300,
            ...
            rgEntry = customtkinter.CTkEntry(
                frameFuncionario, width=300, textvariable=rgSave
            )
            rgEntry.place(x=25, y=80)

            nomeEntry = customtkinter.CTkEntry(
                frameFuncionario, width=300, textvariable=nomeSave
            )
            nomeEntry.place(x=25, y=120)

            cargoEntry = customtkinter.CTkEntry(
                master=frameFuncionario, textvariable=cargoSave, width=300
            )
            cargoEntry.place(x=25, y=160)

            salarioEntry = customtkinter.CTkEntry(
                master=frameFuncionario, textvariable=salarioSave, width=300
            )
            salarioEntry.place(x=25, y=200)

            enderecoEntry = customtkinter.CTkEntry(
                frameFuncionario, textvariable=enderecoSave, width=300
            )
            enderecoEntry.place(x=25, y=240)

            bairroEntry = customtkinter.CTkEntry(
                frameFuncionario, textvariable=bairroSave, width=300
            )
            bairroEntry.place(x=25, y=280)

            numeroEntry = customtkinter.CTkEntry(
                frameFuncionario, textvariable=numeroSave, width=300
            )
            numeroEntry.place(x=25, y=320)

            cepEntry = customtkinter.CTkEntry(
                frameFuncionario, textvariable=cepSave, width=300
            )
            cepEntry.place(x=25, y=360)

            emailEntry = customtkinter.CTkEntry(
                master=frameFuncionario, textvariable=emailSave, width=300
            )
            emailEntry.place(x=25, y=400)

            telefoneEntry = customtkinter.CTkEntry(
                master=frameFuncionario, textvariable=telefoneSave, width=300
            )
            ...
            saveFuncionario = customtkinter.CTkButton(
                master=frameFuncionario,
        ...
        def telaCadastrarCliente():
            ...
            # Títulos
            labelCpfCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="CPF: ",
            ).place(x=280, y=40)

            labelRgCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="RG: ",
            ).place(x=280, y=80)

            labelNomeCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Nome: ",
            ).place(x=280, y=120)

            labelEnderecoCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Endereço: ",
            ).place(x=280, y=160)

            labelNumeroCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Número: ",
            ).place(x=280, y=200)

            labelBairroCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Bairro: ",
            ).place(x=280, y=240)

            labelCepCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Cep: ",
            ).place(x=280, y=280)

            labelTelefoneCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Telefone: ",
            ).place(x=280, y=320)

            labelEmailCliente = customtkinter.CTkLabel(
                master=frameLabelCliente,
                text="Email: ",
            ).place(x=280, y=360)
            ...
            # Entrada de dados
            cpfCliente = customtkinter.CTkEntry(
                master=frameCliente, width=300, textvariable=cpfClienteSave
            ).place(x=25, y=40)

            rgCliente = customtkinter.CTkEntry(
                master=frameCliente, width=300, textvariable=rgClienteSave
            ).place(x=25, y=80)

            nomeCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=nomeClienteSave, width=300
            ).place(x=25, y=120)

            enderecoCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=enderecoClienteSave, width=300
            ).place(x=25, y=160)

            numeroCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=numeroClienteSave, width=300
            ).place(x=25, y=200)

            bairroCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=bairroClienteSave, width=300
            ).place(x=25, y=240)

            cepCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=cepClienteSave, width=300
            ).place(x=25, y=280)

            telefoneCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=telefoneClienteSave, width=300
            ).place(x=25, y=320)

            emailCliente = customtkinter.CTkEntry(
                master=frameCliente, textvariable=emailClienteSave, width=300
            ).place(x=25, y=360)
            ...
            saveCliente = customtkinter.CTkButton(
                master=frameCliente,
                text="Cadastrar Cliente",
                width=300,
                height=30,
        ...
        def telaCadastrarVeiculo():
            ...
            # Título
            labelModelo = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Modelo: ",
            ).place(x=280, y=40)

            labelMarca = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Marca: ",
            ).place(x=280, y=80)

            labelAno = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Ano: ",
            ).place(x=280, y=120)

            labelCor = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Cor: ",
            ).place(x=280, y=160)

            labelPreco = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Preço: ",
            ).place(x=280, y=200)

            labelPlaca = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Placa: ",
            ).place(x=280, y=240)

            labelKmRodado = customtkinter.CTkLabel(
                master=frameLabelVeiculo,
                text="Km rodado: ",
            ).place(x=280, y=280)

            # Entrada de dados
            modeloVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo,
                width=300,
                textvariable=modeloVeiculoSave,
            ).place(x=25, y=40)

            marcaVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo,
                width=300,
                textvariable=marcaVeiculoSave,
            ).place(x=25, y=80)

            anoVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo, textvariable=anoVeiculoSave, width=300
            ).place(x=25, y=120)

            corVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo, textvariable=corVeiculoSave, width=300
            ).place(x=25, y=160)

            precoVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo, textvariable=precoVeiculoSave, width=300
            ).place(x=25, y=200)

            placaVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo, textvariable=placaVeiculoSave, width=300
            ).place(x=25, y=240)

            kmRodadoVeiculo = customtkinter.CTkEntry(
                master=frameVeiculo, textvariable=kmRodadoSave, width=300
            ).place(x=25, y=280)

            # Botão save
            saveVeiculo = customtkinter.CTkButton(
                master=frameVeiculo,
        ...
        def telaPesquisarFuncionario():
            ...
            # Titulo
            labelNomeFunc = customtkinter.CTkLabel(
                frameLabelPesquisarFuncionario,
                text="Nome: ",
            ).place(x=280, y=40)

            # Entrada de dados
            nomeFuncPesquisar = customtkinter.CTkEntry(
                framePesquisarFuncionario,
                width=300,
                ...
                if searchTerm:
                    ...
                    if len(results) < 1:
                        customtkinter.CTkLabel(
                            scrollableFuncionarioFrame,
                            text="Não foi possível encontar.",
                        ).pack(side="top")
                    ...
                    for i, result in enumerate(results):
                        ...
                        customtkinter.CTkLabel(
                            labelFrame,
                            text="Endereço: " + result[5] + ", " + str(result[7]),
                            font=("Helvetica", 14),
                            height=20,
                            width=300,
                            anchor=W,
            ...
            # Botão save
            savePesFuncionario = customtkinter.CTkButton(
                master=framePesquisarFuncionario,
                text="Pesquisar Funcionário",
                width=300,
                height=30,
                font=("Roboto", 16),
        ...
        def telaPesquisarCliente():
            ...
            label = customtkinter.CTkLabel(
                master=framePesquisarCliente,
                text="Pesquisar Cliente",
            ).place(x=25, y=5)

            # Título
            labelNomeClientePesquisar = customtkinter.CTkLabel(
                master=frameLabelPesquisarCliente,
                text="Nome: ",
            ).place(x=280, y=40)

            # Entrada de dados
            nomeClientePesquisar = customtkinter.CTkEntry(
                master=framePesquisarCliente,
                width=300,
        ...
        def telaPesquisarVeiculo():
            ...
            label = customtkinter.CTkLabel(
                master=framePesquisarVeiculo,
                text="Pesquisar Veículo",
            ).place(x=25, y=5)

            # Título
            labelModeloVeiculo = customtkinter.CTkLabel(
                master=frameLabelPesquisarVeiculo,
                text="Nome: ",
            ).place(x=280, y=40)

            # Entrada de dados
            modeloPesquisar = customtkinter.CTkEntry(
                master=framePesquisarVeiculo,
                width=300,
            ...
            def pesquisarVeiculo():
                ...
                if searchTerm:
                    ...
                    for i, result in enumerate(results):
                        ...
                        customtkinter.CTkLabel(
                            labelFrame,
                            text="Marca: " + result[3] + " - Placa: " + result[4],
                            font=("Helvetica", 14),
                            height=20,
                            width=625,
                            anchor=W,
        ...
        def telaHistoricoVendas():
            ...
            def pesquisarHistorico():
                ...
                for i, result in enumerate(results):
                    ...
                    customtkinter.CTkLabel(
                        labelFrame,
                        text="Placa do carro comprado: " + result[4],
                        font=("Helvetica", 14),
                        height=40,
                        width=625,
                        anchor=NW,
            ...
            # Botão save
            exibirHistorico = customtkinter.CTkButton(
                master=frameHistoricoVendas,
        ...
        def telaRealizarVenda():
            ...
            # Frame com os títulos
            frameLabelRealizarVenda = customtkinter.CTkFrame(
                janela, width=350, height=600
            )
            frameLabelRealizarVenda.pack(side=LEFT)

            label = customtkinter.CTkLabel(
                master=frameRealizarVenda,
                text="Realizar Venda",
            ).place(x=25, y=5)

            # Titulo######################
            labelNomeFuncionario = customtkinter.CTkLabel(
                master=frameLabelRealizarVenda,
            ...
            nomeEntry = customtkinter.CTkEntry(
                master=frameRealizarVenda, width=300, textvariable=nomeFuncPesquisarSave
            ).place(x=25, y=40)

            nomeCliente = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=nomeClienteSave, width=300
            ).place(x=25, y=80)

            cpfCliente = customtkinter.CTkEntry(
                master=frameRealizarVenda, width=300, textvariable=cpfClienteSave
            ).place(x=25, y=120)
            ...
            anoVeiculo = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=anoVeiculoSave, width=300
            ).place(x=25, y=240)

            corVeiculo = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=corVeiculoSave, width=300
            ).place(x=25, y=280)

            precoVeiculo = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=precoVeiculoSave, width=300
            ).place(x=25, y=320)

            placaVeiculo = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=placaVeiculoSave, width=300
            ).place(x=25, y=360)

            kmRodadoVeiculo = customtkinter.CTkEntry(
                master=frameRealizarVenda, textvariable=kmRodadoSave, width=300
            ).place(x=25, y=400)
        ...
        botao4 = customtkinter.CTkButton(
            master=frame,
            text="Pesquisar Cliente",
            width=300,
            height=30,
        ...
        botao5 = customtkinter.CTkButton(
            master=frame,
            text="Cadastrar Veículo",
            width=300,
            height=30,
        ...
        botao6 = customtkinter.CTkButton(
            master=frame,
            text="Pesquisar Veículo",
            width=300,
            height=30,
        ...
        botao7 = customtkinter.CTkButton(
            master=frame,
            text="Histórico de Vendas",
            width=300,
            height=30,
        ...
        botao8 = customtkinter.CTkButton(
            master=frame,
            text="Realizar Venda",
            width=300,
            height=30,
